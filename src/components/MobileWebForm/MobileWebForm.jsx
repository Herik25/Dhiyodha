...
// import { BiChevronLeft, BiChevronRight, BiLeftArrow } from "react-icons/bi";
...
//               {currentStep > 2 && "Other Business Details"}
//             </span>
...
//                   <div
//                     className=" mx-5 bg-[#061237] py-2 text-center text-[#E2DDFB] rounded-md shadow-md shadow-[#DAD3FB] mb-2"
//                     onClick={() => {
//                       currentStep === steps.length
//                         ? setComplete(true)
//                         : setCurrentStep((prev) => prev + 1);
